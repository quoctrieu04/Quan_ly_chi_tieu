        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                const Icon(Icons.account_circle_rounded, size: 80, color: _mint),
                  ...
                  child: ElevatedButton(
                    onPressed: auth.loading
                        ...
                        : () async {
                            ...
                            if (ok && mounted) {
                              safeShowSnackBar(context, const SnackBar(content: Text('Đăng nhập thành công!', style: TextStyle(fontWeight: FontWeight.bold))));
                    ...
                    child: auth.loading
                        ...
                        : const Text('ĐĂNG NHẬP', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: Colors.white, letterSpacing: 1)),
                  ),
                ),
                ...
                Row(
                  ...
                  children: [
                    Text('Chưa có tài khoản? ', style: TextStyle(color: isDark ? Colors.white60 : const Color(0xFF64748B), fontSize: 15, fontWeight: FontWeight.w500)),
                    GestureDetector(
                      onTap: () => Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const RegisterPage())),
                      child: const Text('Đăng ký ngay', style: TextStyle(color: _mint, fontWeight: FontWeight.w800, fontSize: 15)),
                    ),
                  ],
                ),
              ],
