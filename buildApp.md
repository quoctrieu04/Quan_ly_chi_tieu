...
php artisan forecast:weekly-snapshot --source-week-start=YYYY-MM-DD --user-id=USER_ID --force (--source-week-start=YYYY-MM-DD: tuần đầu vào ví dụ như dự báo tuần này là nhập tuần trc)
